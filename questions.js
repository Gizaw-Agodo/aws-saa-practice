const questions = [
  ...
  "answer": 0,
  "explanation": "An S3 gateway VPC endpoint provides private connectivity from a VPC to Amazon S3 without requiring internet access, NAT gateways, or public IP addresses. Traffic stays within the AWS network."
}, 
...
// question 92 
{
  ...
  "answer": 2,
  "explanation": "An S3 gateway VPC endpoint allows private access from EC2 instances in the VPC to Amazon S3 without using the internet. A restrictive S3 bucket policy can limit access to only the application's VPC or IAM role, following the principle of least privilege."
}, 
...
// question 94
{
  ...
  "answer": 2,
  "explanation": "Amazon S3 event notifications with Amazon SQS and AWS Lambda provide a serverless, scalable, and low-maintenance solution. Lambda automatically scales based on demand, processes files quickly after upload, and avoids managing EC2 instances or other infrastructure."
}, 
...
// question 95
{
  ...
  "answer": 3,
  "explanation": "Amazon RDS read replicas allow read traffic to be separated from write traffic by offloading queries to replica databases. Configuring the read replicas with the same compute and storage resources ensures they can handle a similar workload as the source database. Multi-AZ is for high availability, not read scaling."
}, 
...
// question 98 
{
  ...
  "answer": 2,
  "explanation": "When Lambda polls messages from SQS, the message remains hidden only for the duration of the visibility timeout. If Lambda processing takes longer than this timeout, SQS makes the message visible again, causing Lambda to process it a second time. Increasing the SQS visibility timeout to be longer than the Lambda function timeout plus batch window timeout prevents duplicate processing. This requires no application code changes and has the least operational overhead."
}, 
